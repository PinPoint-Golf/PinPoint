...
set PATH=%PATH%;$jom
cd /d "$repo"
"$cmake" -S . -B "$BuildDir" -G "NMake Makefiles JOM" -DCMAKE_BUILD_TYPE=Release -DPP_SHIPPING_BUILD=ON -DCMAKE_PREFIX_PATH="$QtPrefix" -DOPENSSL_ROOT_DIR="$OpenSslRoot" || exit /b 1
