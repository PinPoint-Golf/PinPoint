...
pinpoint::hm::ReferenceAnchor HmSessionWorker::referenceAnchor() const
{
    QMutexLocker lk(&m_mutex);
    return m_anchor;
}
...
void HmSessionWorker::pollHistory()
{
    ...
    for (size_t i = 0; i < block->gap_count; ++i)
        r.gaps.push_back(pinpoint::hm::HistoryResult::Gap{
